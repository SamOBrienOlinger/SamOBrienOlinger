...
<sub>The public preview shows the interface; account and API features require the configured backend.</sub>
...
**Public service · Executive Officer**<br>
Junior Software Developer at the Department of Social Protection.

**Strategy & collaboration · Strategic Development & Innovation**<br>
...
**Understand** — find the real problem.<br>
**Simplify** — translate knowledge for all.<br>
